"""
VoxX - Page 4: Зрение (Описание Окружения и OCR)
"""
import sys
...
from features.vision.presentation.vision_view import render_vision_screen

st.set_page_config(
    page_title="VoxX — Описание Зрения",
    page_icon="👁️",
    layout="wide",
...
render_app_header(title_suffix="— Описание Зрения", icon="👁️")
render_vision_screen()
